...
print("Key with name '{key.name}' created with key type '{key.key_type}'")
...
print("Backup created for key with name '{key.name}'.")
...
print("Deleted key with name '{deleted_key.name}'")
...
time.sleep(60)
print("Purged key with name '{deleted_key.name}'")
...
print("Restored key with name '{key.name}'")
